...
یک اپلیکیشن وب پیشرفته برای ردیابی لحظهای قیمت طلا دلار یورو و سایر ارزها با قابلیت ربات تلگرام و رابط کاربری مدرن.

## 📋 فهرست مطالب

- [معرفی پروه](#معرفی-پروه)
- [ویگیها](#ویگیها)
- [نصب و راهاندازی](#نصب-و-راهاندازی)
- [مستندات API](#مستندات-api)
- [استفاده از ربات تلگرام](#استفاده-از-ربات-تلگرام)
- [ساختار پروه](#ساختار-پروه)
- [تنظیمات پیشرفته](#تنظیمات-پیشرفته)
- [مشکلات رایج](#مشکلات-رایج)
- [مشارکت در پروه](#مشارکت-در-پروه)

## 🎯 معرفی پروه

**Gold Tracker** یک سیستم جامع برای ردیابی قیمتهای لحظهای طلا و ارزهای مختلف است که شامل:

- **Frontend**: رابط کاربری React با طراحی مدرن و ریسپانسیو
- **Backend**: API Flask با قابلیتهای پیشرفته
- **Telegram Bot**: ربات تلگرام برای دسترسی آسان
- **Real-time Data**: دریافت دادههای لحظهای از منابع معتبر

### 🔗 منابع داده

- **قیمت طلا**: [تجهیزات جییو](https://www.tgju.org/profile/geram18)
- **قیمت دلار/تتر**: [آرزدیجیتال](https://arzdigital.com/coins/tether/)
- **قیمت یورو**: [تجهیزات جییو](https://www.tgju.org/profile/price_eur)
...
- **pi.py**: سرور Flask با endpoints مختلف
- **ot.py**: ربات تلگرام با قابلیت Web App
- **gold.js**: کامپوننت React اصلی
- **equirements.txt**: وابستگیهای Python
...
این پروه تحت مجوز MIT منتشر شده است.
...
از تمام کسانی که در توسعه این پروه مشارکت کردهاند تشکر میکنیم.

---

⭐ اگر این پروه برای شما مفید بود لطفا ستاره بدهید!
